...
class EnginePool:
    ...
    async def get_engine(
        ...
        while True:
            ...
            async with self._lock:
                ...
                if entry.is_loading:
                    ...
                    load_settings = self._effective_qwen4_model_settings(
                        entry, model_settings, ceiling=ngram_admission_ceiling
                    )
                    load_settings = self._effective_deepseek_v41_model_settings(
                        entry, load_settings, ceiling=ngram_admission_ceiling
                    )
                    ngram_admission_override = load_settings is not model_settings
            ...
            async with self._lock:
                ...
                if loaded is not None and ngram_admission_override and expected_signature is not None:
    ...
    def get_status(self) -> dict:
        ...
        untracked_native_memory = self._untracked_native_memory(observed_native_memory)
        models = []
