...
class VLMBatchedEngine(BaseEngine):
    ...
    async def start(self) -> None:
        ...
        # Build mlx-lm decode model for stable batched decode by sharing VLM
        # weights. This keeps VLM prefill in mlx-vlm while reusing mlx-lm's
        # batched decode path without duplicating GPU-resident weights.
